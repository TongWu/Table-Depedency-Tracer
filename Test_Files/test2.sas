/**************************************************************************** 
 * Job:             POPULATE_ALL_TARGET_T_ADM_PR_RFD_PT   A5TM814S.BN000MIO * 
 ...
 *                                                                          * 
 * Source Tables:   T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
 *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
 *                  T_ADM_CTL_LOOP_ITER -                 A5TM814S.BH000LF6 * 
 *                   ads_stg.T_ADM_CTL_LOOP_ITER                            * 
 *                  T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
 *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
 *                  T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
 *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
 * Target Tables:   T_ADM_CTL_LOOP_ITER -                 A5TM814S.BH000LF6 * 
 *                   ads_stg.T_ADM_CTL_LOOP_ITER                            * 
 *                  T_ADM_PR_RFD_PT -                     A5TM814S.BH000L5S * 
 *                   ads_tgt.T_ADM_PR_RFD_PT                                * 
 *                  T_ADM_PR_RFD_PT -                     A5TM814S.BH000L5S * 
 *                   ads_tgt.T_ADM_PR_RFD_PT                                * 
 *                                                                          * 
 * Generated on:    Tuesday, 5 January, 2021 10:26:06 AM SGT                * 
...
%let jobID = %quote(A5TM814S.BN000MIO);
%let etls_jobName = %nrquote(POPULATE_ALL_TARGET_T_ADM_PR_RFD_PT);
...
/*==========================================================================* 
 * Step:            Delete_Table                          A5TM814S.BP0013P4 * 
 * Transform:       Delete_Table                                            * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
 *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
 * Target Table:    T_ADM_CTL_LOOP_ITER -                 A5TM814S.BH000LF6 * 
 *                   ads_stg.T_ADM_CTL_LOOP_ITER                            * 
 *==========================================================================*/ 

%let transformID = %quote(A5TM814S.BP0013P4);
%let trans_rc = 0;
...
%macro etls_recordCheck; 
   %let etls_recCheckExist = %eval(%sysfunc(exist(UDPADMS.T_ADM_PR_RFD_PT, DATA)) or 
         %sysfunc(exist(UDPADMS.T_ADM_PR_RFD_PT, VIEW))); 
   ...
   %do;
      ...
      proc contents data = UDPADMS.T_ADM_PR_RFD_PT out = work.etls_contents(keep = nobs) noprint; 
      run; 
...
%let SYSLAST = %nrquote(UDPADMS.T_ADM_PR_RFD_PT); 

%let _INPUT_count = 1; 
%let _INPUT = UDPADMS.T_ADM_PR_RFD_PT;
%let _INPUT_connect = null;
%let _INPUT_engine = BASE;
%let _INPUT_memtype = DATA;
%let _INPUT_options = %nrquote();
%let _INPUT_alter = %nrquote();
%let _INPUT_path = %nrquote(/ADMS_UDP/ADMS_UDP_DATA/Extract/T_ADM_PR_RFD_PT%(Table%));
%let _INPUT_type = 1;
%let _INPUT_label = %nrquote();

%let _INPUT0 = UDPADMS.T_ADM_PR_RFD_PT;
...
%let _INPUT0_path = %nrquote(/ADMS_UDP/ADMS_UDP_DATA/Extract/T_ADM_PR_RFD_PT%(Table%));
%let _INPUT0_type = 1;
...
/*==========================================================================* 
 * Step:            Loop                                  A5TM814S.BP0013P5 * 
 * Transform:       Loop                                                    * 
 * Description:                                                             * 
 *                                                                          * 
 * Source Table:    T_ADM_CTL_LOOP_ITER -                 A5TM814S.BH000LF6 * 
 *                   ads_stg.T_ADM_CTL_LOOP_ITER                            * 
 * Target Table:    Loop - work.LOOP_STATUS               A5TM814S.BE000RH9 * 
 *==========================================================================*/ 

%let transformID = %quote(A5TM814S.BP0013P5);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%macro etls_loopWESS31U; 
   %local etls_filePrefix; 
   %let etls_filePrefix = ; 
   
   %macro etls_processToLoopWESS324(parameterTable=, row=, handleName=rmt);
      %local etls_parmvars; 
      ...
      %macro etls_jobWESS32E; 
      
         /**************************************************************************** 
          * Job:             POPULATE_TARGET_T_ADM_PR_RFD_PT       A5TM814S.BN000MPD * 
          * Description:     Version 1.0                                             * 
          *                                                                          * 
          * Metadata Server: NESAS01R.IRASOR.GOV.SG                                  * 
          * Port:            8565                                                    * 
          ...
          * Server:          SASDI                                 A5TM814S.AT000002 * 
          *                                                                          * 
          * Source Tables:   BASE_ADM_PR_RFD_PT -                  A5TM814S.BH000MK2 * 
          *                   UDPADMS.BASE_ADM_PR_RFD_PT                             * 
          *                  BASE_ADM_PR_RFD_PT -                  A5TM814S.BH000MK2 * 
          *                   UDPADMS.BASE_ADM_PR_RFD_PT                             * 
          * Target Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
          *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
          *                                                                          * 
          * Generated on:    Tuesday, 5 January, 2021 10:26:07 AM SGT                * 
          * Generated by:    INL9BYP@IRAS                                            * 
          * Version:         SAS Data Integration Studio 4.904                       * 
          ****************************************************************************/ 
         ...
         /* General macro variables  */ 
         %let jobID = %quote(A5TM814S.BN000MPD);
         %let etls_jobName = %nrquote(POPULATE_TARGET_T_ADM_PR_RFD_PT);
         %let etls_userID = %nrquote(INL9BYP@IRAS);
         ...
         /*==========================================================================* 
          * Step:            Extract 4 YA                          A5TM814S.BP00157Q * 
          * Transform:       Extract                                                 * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Table:    BASE_ADM_PR_RFD_PT -                  A5TM814S.BH000MK2 * 
          *                   UDPADMS.BASE_ADM_PR_RFD_PT                             * 
          * Target Table:    Extract - work.W1CLZ92T               A5TM814S.BE000S3N * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A5TM814S.BP00157Q);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         ...
         %let etls_recnt = 0; 
         %macro etls_recordCheck; 
            %let etls_recCheckExist = %eval(%sysfunc(exist(UDPADMS.BASE_ADM_PR_RFD_PT, DATA)) or 
                  %sysfunc(exist(UDPADMS.BASE_ADM_PR_RFD_PT, VIEW))); 
            ...
            %do;
               ...
               proc contents data = UDPADMS.BASE_ADM_PR_RFD_PT out = work.etls_contents(keep = nobs) noprint; 
               run; 
         ...
         %let SYSLAST = %nrquote(UDPADMS.BASE_ADM_PR_RFD_PT); 
         ...
         /*==========================================================================* 
          * Step:            Set_of_11_test2                       A5TM814S.BP00157R * 
          * Transform:       Set_of_11                                               * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Table:    Extract - work.W1CLZ92T               A5TM814S.BE000S3N * 
          * Target Table:    Set_of_11_test2_OUTPUT0 -             A5TM814S.BE000S3O * 
          *                   work.T_ADM_PR_RFD_PT_Setof11                           * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A5TM814S.BP00157R);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         ...
         %let _INPUT_options = %nrquote();
         %let _INPUT_alter = %nrquote();
         %let _INPUT_path = %nrquote(/Extract_A5TM814S.BE000S3N%(WorkTable%));
         %let _INPUT_type = 1;
         %let _INPUT_label = %nrquote();
         ...
         %let _INPUT0_options = %nrquote();
         %let _INPUT0_alter = %nrquote();
         %let _INPUT0_path = %nrquote(/Extract_A5TM814S.BE000S3N%(WorkTable%));
         %let _INPUT0_type = 1;
         %let _INPUT0_label = %nrquote();
         
         %let _OUTPUT_count = 1; 
         %let _OUTPUT = work.T_ADM_PR_RFD_PT_Setof11;
         %let _OUTPUT_connect = ;
         %let _OUTPUT_engine = ;
         %let _OUTPUT_memtype = DATA;
         %let _OUTPUT_options = %nrquote();
         %let _OUTPUT_alter = %nrquote();
         %let _OUTPUT_path = %nrquote(/Set_of_11_test2_OUTPUT0_A5TM814S.BE000S3O%(WorkTable%));
         %let _OUTPUT_type = 1;
         %let _OUTPUT_label = %nrquote();
         /* List of target columns to keep  */ 
         %let _OUTPUT_keep = id_internal AM_PT_REFUND_CURR AM_PT_REFUND_TOT AM_PT_REFUND_AVE 
                 IN_PT_REFUND_NC AM_PT_REFUND_STD AM_PT_REFUND_DEVN AM_PT_REFUND_RATE 
                 RO_PT_REFUND_PPT IN_PT_REFUND_CURR IN_PT_REFUND_PREV 
                 IN_PT_REFUND_START;
         
         %let _OUTPUT0 = work.T_ADM_PR_RFD_PT_Setof11;
         %let _OUTPUT0_connect = ;
         %let _OUTPUT0_engine = ;
         %let _OUTPUT0_memtype = DATA;
         %let _OUTPUT0_options = %nrquote();
         %let _OUTPUT0_alter = %nrquote();
         %let _OUTPUT0_path = %nrquote(/Set_of_11_test2_OUTPUT0_A5TM814S.BE000S3O%(WorkTable%));
         %let _OUTPUT0_type = 1;
         %let _OUTPUT0_label = %nrquote();
         /* List of target columns to keep  */ 
         %let _OUTPUT0_keep = id_internal AM_PT_REFUND_CURR AM_PT_REFUND_TOT AM_PT_REFUND_AVE 
                 IN_PT_REFUND_NC AM_PT_REFUND_STD AM_PT_REFUND_DEVN AM_PT_REFUND_RATE 
                 RO_PT_REFUND_PPT IN_PT_REFUND_CURR IN_PT_REFUND_PREV 
                 IN_PT_REFUND_START;
         ...
         proc datasets lib=work nolist nowarn memtype = (data view);
            delete T_ADM_PR_RFD_PT_Setof11;
         quit;
         
         
         /* List of target columns to keep  */ 
         %let _keep = id_internal AM_PT_REFUND_CURR AM_PT_REFUND_TOT AM_PT_REFUND_AVE 
                 IN_PT_REFUND_NC AM_PT_REFUND_STD AM_PT_REFUND_DEVN AM_PT_REFUND_RATE 
                 RO_PT_REFUND_PPT IN_PT_REFUND_CURR IN_PT_REFUND_PREV 
                 IN_PT_REFUND_START;
         /* List of target columns to keep  */ 
         %let keep = id_internal AM_PT_REFUND_CURR AM_PT_REFUND_TOT AM_PT_REFUND_AVE 
                 IN_PT_REFUND_NC AM_PT_REFUND_STD AM_PT_REFUND_DEVN AM_PT_REFUND_RATE 
                 RO_PT_REFUND_PPT IN_PT_REFUND_CURR IN_PT_REFUND_PREV 
                 IN_PT_REFUND_START;
         ...
         /*==========================================================================* 
          * Step:            Join                                  A5TM814S.BP00157S * 
          * Transform:       Join                                                    * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Tables:   Set_of_11_test2_OUTPUT0 -             A5TM814S.BE000S3O * 
          *                   work.T_ADM_PR_RFD_PT_Setof11                           * 
          *                  BASE_ADM_PR_RFD_PT -                  A5TM814S.BH000MK2 * 
          *                   UDPADMS.BASE_ADM_PR_RFD_PT                             * 
          * Target Table:    Join - work.W1O4T6Y9                  A5TM814S.BE000S3P * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A5TM814S.BP00157S);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         ...
         %let etls_recnt = 0; 
         %macro etls_recordCheck; 
            %let etls_recCheckExist = %eval(%sysfunc(exist(work.T_ADM_PR_RFD_PT_Setof11, DATA)) or 
                  %sysfunc(exist(work.T_ADM_PR_RFD_PT_Setof11, VIEW))); 
            ...
            %do;
               ...
               proc contents data = work.T_ADM_PR_RFD_PT_Setof11 out = work.etls_contents(keep = nobs) noprint; 
               run; 
         ...
         proc sql;
            create table work.W1O4T6Y9 as
            select
               BASE_ADM_PR_RFD_PT.id_internal length = 8   
                  format = 17.
                  informat = 17.
                  label = 'System generated number that uniquely identifies the Tax entity',
               BASE_ADM_PR_RFD_PT.cd_tax length = 8   
                  format = 13.
                  informat = 13.
                  label = 'cd_tax',
               T_ADM_PR_RFD_PT_Setof11.AM_PT_REFUND_CURR length = 8   
                  format = 20.2
                  informat = 20.2
                  label = 'PT Tax Type Refund for Current YA',
               T_ADM_PR_RFD_PT_Setof11.AM_PT_REFUND_TOT length = 8   
                  format = 20.2
                  informat = 20.2
                  label = 'Total PT Tax Type Refund for the last 4 YA',
               T_ADM_PR_RFD_PT_Setof11.AM_PT_REFUND_AVE length = 8   
                  format = 20.2
                  informat = 20.2
                  label = 'Ave PT Tax Type Refund for the last 4 YA',
               T_ADM_PR_RFD_PT_Setof11.IN_PT_REFUND_NC length = 1   
                  label = 'No Change Indicator in PT Tax Type Refund from Previous YA',
               T_ADM_PR_RFD_PT_Setof11.AM_PT_REFUND_STD length = 8   
                  format = 20.2
                  informat = 20.2
                  label = 'Variation in PT Tax Type Refund for the last 4 YA',
               T_ADM_PR_RFD_PT_Setof11.AM_PT_REFUND_DEVN length = 8   
                  label = 'Deviation of Current PT Tax Type Refund from Mean in the last 4 YA',
               T_ADM_PR_RFD_PT_Setof11.AM_PT_REFUND_RATE length = 8   
                  label = 'Rate of Change in PT Tax Type Refund from Previous YA',
               T_ADM_PR_RFD_PT_Setof11.RO_PT_REFUND_PPT length = 8   
                  label = 'Proportion of PT Tax Type Refund vs Average of the last 4 YA',
               T_ADM_PR_RFD_PT_Setof11.IN_PT_REFUND_CURR length = 1   
                  label = 'PT Tax Type Refund Indicator (Current YA)',
               T_ADM_PR_RFD_PT_Setof11.IN_PT_REFUND_PREV length = 1   
                  label = 'PT Tax Type Refund Indicator (Previous YA)',
               T_ADM_PR_RFD_PT_Setof11.IN_PT_REFUND_START length = 1   
                  label = 'PT Tax Type Refund Indicator (Last 4 YA)',
               BASE_ADM_PR_RFD_PT.nm_src_system length = 50   
                  format = $50.
                  informat = $50.
                  label = 'ADMS Source System',
               1+ &curr_ya - &adms_period as YR_ADMS_YA length = 8   
                  label = 'ADMS YA'
            from
               work.T_ADM_PR_RFD_PT_Setof11 right join 
               UDPADMS.BASE_ADM_PR_RFD_PT
               (
                  ...
                  on
                  (
                     T_ADM_PR_RFD_PT_Setof11.id_internal = BASE_ADM_PR_RFD_PT.id_internal
                  )
            ;
         quit;
         ...
         /*==========================================================================* 
          * Step:            Table Loader                          A5TM814S.BP00157T * 
          * Transform:       Table Loader (Version 2.1)                              * 
          * Description:                                                             * 
          *                                                                          * 
          * Source Table:    Join - work.W1O4T6Y9                  A5TM814S.BE000S3P * 
          * Target Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
          *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
          *==========================================================================*/ 
         
         %let transformID = %quote(A5TM814S.BP00157T);
         %let trans_rc = 0;
         %let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
         
         %let SYSLAST = %nrquote(work.W1O4T6Y9); 
         ...
         %macro etls_loader;
            ...
            %let etls_tableExist = %eval(%sysfunc(exist(UDPADMS.T_ADM_PR_RFD_PT, DATA)) or 
                  %sysfunc(exist(UDPADMS.T_ADM_PR_RFD_PT, VIEW))); 
            ...
            %do;  /* if table does not exist  */ 
               ...
               data UDPADMS.T_ADM_PR_RFD_PT;
                  ...
                  attrib cd_tax length = 8
                     ...
                     informat = 13.
                     label = 'cd_tax'; 
                  attrib AM_PT_REFUND_CURR length = 8
                     format = 20.2
                     informat = 20.2
                     label = 'PT Tax Type Refund for Current YA'; 
                  attrib AM_PT_REFUND_TOT length = 8
                     format = 20.2
                     informat = 20.2
                     label = 'Total PT Tax Type Refund for the last 4 YA'; 
                  attrib AM_PT_REFUND_AVE length = 8
                     format = 20.2
                     informat = 20.2
                     label = 'Ave PT Tax Type Refund for the last 4 YA'; 
                  attrib IN_PT_REFUND_NC length = $1
                     label = 'No Change Indicator in PT Tax Type Refund from Previous YA'; 
                  attrib AM_PT_REFUND_STD length = 8
                     format = 20.2
                     informat = 20.2
                     label = 'Variation in PT Tax Type Refund for the last 4 YA'; 
                  attrib AM_PT_REFUND_DEVN length = 8
                     label = 'Deviation of Current PT Tax Type Refund from Mean in the last 4 YA'; 
                  attrib AM_PT_REFUND_RATE length = 8
                     label = 'Rate of Change in PT Tax Type Refund from Previous YA'; 
                  attrib RO_PT_REFUND_PPT length = 8
                     label = 'Proportion of PT Tax Type Refund vs Average of the last 4 YA'; 
                  attrib IN_PT_REFUND_CURR length = $1
                     label = 'PT Tax Type Refund Indicator (Current YA)'; 
                  attrib IN_PT_REFUND_PREV length = $1
                     label = 'PT Tax Type Refund Indicator (Previous YA)'; 
                  attrib IN_PT_REFUND_START length = $1
                     label = 'PT Tax Type Refund Indicator (Last 4 YA)'; 
            ...
            proc append base = UDPADMS.T_ADM_PR_RFD_PT 
         ...
         /**  Job end POPULATE_TARGET_T_ADM_PR_RFD_PT **/
         
         /* Reset jobid and name */
         %let jobID = %quote(A5TM814S.BN000MIO);
         %let etls_jobName = %nrquote(POPULATE_ALL_TARGET_T_ADM_PR_RFD_PT);
         
      %mend etls_jobWESS32E; 
   ...
   %mend etls_processToLoopWESS324;
   ...
   %let etls_parameterTable = work.WESS37L; 
   ...
   data &etls_statusTable 
      ...
      set &etls_controlTable(WHERE=(NM_TARGET_TABLE='T_ADM_PR_RFD_PT'));
   run;
   ...
   proc sql; 
      create table &etls_parameterTable as 
         ...
         from &etls_controlTable(WHERE=(NM_TARGET_TABLE='T_ADM_PR_RFD_PT')); 
   quit; 
   ...
   %do; 
      %do %until (&&&etls_controlName ge &&&etls_controlName._max); 
         ...
         %etls_processToLoopWESS324(parameterTable=&etls_parameterTable, row=&&&etls_controlName,
...
/*==========================================================================* 
 * Step:            Loop End                              A5TM814S.BP0013P7 * 
 * Transform:       Loop End                                                * 
 * Description:                                                             * 
 *==========================================================================*/ 

%let transformID = %quote(A5TM814S.BP0013P7);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
/*==========================================================================* 
 * Step:            UDP_Bulk_Load_Target                  A5TM814S.BP00157U * 
 * Transform:       UDP_Bulk_Load_Target                                    * 
 * Description:     S1 - changed                                            * 
 *                                                                          * 
 * Source Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
 *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
 * Target Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000L5S * 
 *                   ads_tgt.T_ADM_PR_RFD_PT                                * 
 *==========================================================================*/ 

%let transformID = %quote(A5TM814S.BP00157U);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
...
%let _OUTPUT_count = 1; 
%let _OUTPUT = ads_tgt.T_ADM_PR_RFD_PT;
...
%let _OUTPUT_options = %nrquote();
%let _OUTPUT_alter = %nrquote();
%let _OUTPUT_path = %nrquote(/ADMS_UDP/ADMS_UDP_DATA/PopulateTarget/T_ADM_PR_RFD_PT%(Table%));
%let _OUTPUT_type = 1;
%let _OUTPUT_label = %nrquote();
/* List of target columns to keep  */ 
%let _OUTPUT_keep = id_internal cd_tax am_pt_refund_curr am_pt_refund_tot am_pt_refund_ave 
        in_pt_refund_nc am_pt_refund_std am_pt_refund_devn am_pt_refund_rate 
        ro_pt_refund_ppt in_pt_refund_curr in_pt_refund_prev 
        in_pt_refund_start yr_adms_ya nm_src_system dt_adms_updated 
        dt_adms_created yr_adms_year mt_adms_month;

%let _OUTPUT0 = ads_tgt.T_ADM_PR_RFD_PT;
...
%let _OUTPUT0_options = %nrquote();
%let _OUTPUT0_alter = %nrquote();
%let _OUTPUT0_path = %nrquote(/ADMS_UDP/ADMS_UDP_DATA/PopulateTarget/T_ADM_PR_RFD_PT%(Table%));
%let _OUTPUT0_type = 1;
%let _OUTPUT0_label = %nrquote();
/* List of target columns to keep  */ 
%let _OUTPUT0_keep = id_internal cd_tax am_pt_refund_curr am_pt_refund_tot am_pt_refund_ave 
        in_pt_refund_nc am_pt_refund_std am_pt_refund_devn am_pt_refund_rate 
        ro_pt_refund_ppt in_pt_refund_curr in_pt_refund_prev 
        in_pt_refund_start yr_adms_ya nm_src_system dt_adms_updated 
        dt_adms_created yr_adms_year mt_adms_month;
...
/* List of target columns to keep  */ 
%let _keep = id_internal cd_tax am_pt_refund_curr am_pt_refund_tot am_pt_refund_ave 
        in_pt_refund_nc am_pt_refund_std am_pt_refund_devn am_pt_refund_rate 
        ro_pt_refund_ppt in_pt_refund_curr in_pt_refund_prev 
        in_pt_refund_start yr_adms_ya nm_src_system dt_adms_updated 
        dt_adms_created yr_adms_year mt_adms_month;
/* List of target columns to keep  */ 
%let keep = id_internal cd_tax am_pt_refund_curr am_pt_refund_tot am_pt_refund_ave 
        in_pt_refund_nc am_pt_refund_std am_pt_refund_devn am_pt_refund_rate 
        ro_pt_refund_ppt in_pt_refund_curr in_pt_refund_prev 
        in_pt_refund_start yr_adms_ya nm_src_system dt_adms_updated 
        dt_adms_created yr_adms_year mt_adms_month;
...
/*==========================================================================* 
 * Step:            UDP_CD_Validation_and_DT_Imputes      A5TM814S.BP0015GG * 
 * Transform:       UDP_CD_Validation_and_DT_Imputes                        * 
 * Description:     Not in S1                                               * 
 *                                                                          * 
 * Source Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000MK1 * 
 *                   UDPADMS.T_ADM_PR_RFD_PT                                * 
 * Target Table:    T_ADM_PR_RFD_PT -                     A5TM814S.BH000L5S * 
...
%let transformID = %quote(A5TM814S.BP0015GG);
%let trans_rc = 0;
%let etls_stepStartTime = %sysfunc(datetime(), datetime20.); 
